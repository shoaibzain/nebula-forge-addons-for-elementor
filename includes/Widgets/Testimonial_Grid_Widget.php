    ...
    protected function register_controls(): void
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Short, authentic quotes build trust and keep conversion paths strong.', 'nebula-forge-addons-for-elementor'),
                'rows' => 3,
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .nfa-testimonials',
                'fields_options' => [
                    'color' => [
                        'default' => '#0b1220',
                    ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .nfa-testimonials' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .nfa-testimonials' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .nfa-testimonials__heading',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#f8fafc',
                'selectors' => [
                    '{{WRAPPER}} .nfa-testimonials__heading' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .nfa-testimonials__subheading',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#cbd5e1',
                'selectors' => [
                    '{{WRAPPER}} .nfa-testimonials__subheading' => 'color: {{VALUE}};',
                ],
            ]
        );
